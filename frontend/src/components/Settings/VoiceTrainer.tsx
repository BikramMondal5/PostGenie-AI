                                ...
                                <div className="p-10">
                                    <div className="flex items-center justify-between mb-8">
                                        ...
                                        <Button
                                            ...
                                            className="bg-pink-600 hover:bg-pink-700 text-white rounded-2xl px-8 h-14 font-bold shadow-xl shadow-pink-200 transition-all flex items-center gap-3 transform hover:scale-105"
                                        >
